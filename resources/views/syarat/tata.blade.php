...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="full">
                <div class="card-body">
                <h1>Menu Input Tata Cara </h1>
                
                <h5 class="modal-title" id="exampleModalLongTitle">Tambah</h5>
                <button type="button" class="btn btn-warning btn-round ml-auto" data-bs-toggle="modal" data-bs-target="#addtata">
                    Input
        ...
        <div class="table-responsive">
            <table class="display table table-striped table-hover">
                ...
                <tbody>
                    @php $no=1; @endphp
                    @foreach($tata as $info)
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $info->nama_tata }}</td>
            ...
            <div class="modal fade" id="addtata" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
